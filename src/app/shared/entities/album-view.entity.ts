...
/**
 * Fields: id, primaryArtistId, name, hash, description, albumType, albumSort, releaseYear, releaseDecade, favorite, albumStylized, primaryArtistName, primaryArtistStylized, songCount, playCount, seconds, songAddDateMax
 */
@ViewEntity({
  name: 'albumView',
  expression: `
