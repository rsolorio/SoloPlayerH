...
/**
 * Fields: id, primaryArtistId, name, hash, description, albumType, albumSort, releaseYear, releaseDecade, favorite, albumStylized, mbId, primaryArtistName, primaryArtistStylized, songCount, playCount, seconds, songAddDateMax
 */
@ViewEntity({
  name: 'albumView',
  expression: `
    SELECT album.id, album.primaryArtistId, album.mbId, album.name, album.hash, album.description, album.albumType, album.albumSort, album.releaseYear, album.releaseDecade, album.favorite, album.albumStylized,
