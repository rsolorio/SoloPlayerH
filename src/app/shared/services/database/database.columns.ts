...
databaseColumns[DbColumn.Mood] = { name: DbColumn.Mood, caption: 'Mood', icon: AppAttributeIcons.Mood, dataType: CriteriaDataType.String };
...
databaseColumns[DbColumn.Explicit] = { name: DbColumn.Explicit, caption: 'Explicit', icon: AppAttributeIcons.Explicit, dataType: CriteriaDataType.Boolean };
