...
databaseColumns[DbColumn.Classification] = { name: DbColumn.Classification, caption: 'Classification', icon: 'mdi-sitemap-outline mdi', dataType: CriteriaDataType.String };
...
databaseColumns[DbColumn.Performers] = { name: DbColumn.Performers, caption: 'Performers', icon: 'mdi-account-multiple mdi', dataType: CriteriaDataType.Number };
